...
library()
<<<<<<< HEAD
-This function summons up a pre-loaded package and applying it to subsequent code
...
```
>>>>>>> 08da14cefd04c3ba5ec8158ccfe4ab4ab6dd4085
read.table()
...
=======
This function creates a group of data
```{r}
data.frame(1, 2, 3, 5)
```
>>>>>>> 08da14cefd04c3ba5ec8158ccfe4ab4ab6dd4085
