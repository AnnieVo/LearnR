...
-It is a package that can process several different document formats such as PDF's, Word documents, slide presentations and web pages
      ...
      -It enables the integration of R code into Latex, Lyx, HTML and many others
...
```{r}
knitr::include_graphics("docs.knit-logo.png")
```
---
...
##"Future proof"
    ...
    -Access all notes, graphs, text, animation etc. in one place
